...
class AccountsAndLockTests(unittest.TestCase):
    ...
    def test_bootstrap_login_roles_and_locked_folder(self):
        ...
        self.assertEqual(self.member.get("/api/media", query_string={"trashed": 1}).status_code, 403)
        self.assertEqual(self.member.post(f"/api/media/{one}/restore").status_code, 403)
